...
z1= npzread("/home/zaldivar/Documents/Androniki/Github/GWBackFinder.py/src/GWBackFinder/data/thetas_for_julia.npy")
length(z1)
#z1=vcat(rand(28),3)
#length(z1)
...
data=GWBackFinder.model(z1[10,:],f,"AA",idx,f_filtered,logbins_27,logbins, Sb1_new3, Sb2_new3, Sb3_new3, Sb4_new3, Sb5_new3, Sb6_new3, Sb7_new3, Sb8_new3, Sb9_new3, Sb10_new3, Sb11_new3, Sb12_new3, Sb13_new3, Sb14_new3, Sb15_new3, Sb16_new3, Sb17_new3, Sb18_new3, Sb19_new3, Sb20_new3, Sb21_new3, Sb22_new3, Sb23_new3, Sb24_new3, Sb25_new3, Sb26_new3)
...
function write_sample(z, label)
    Data_total = GWBackFinder.model(z,f,"AA",idx,f_filtered,logbins_27,logbins, Sb1_new3, Sb2_new3, Sb3_new3, Sb4_new3, Sb5_new3, Sb6_new3, Sb7_new3, Sb8_new3, Sb9_new3, Sb10_new3, Sb11_new3, Sb12_new3, Sb13_new3, Sb14_new3, Sb15_new3, Sb16_new3, Sb17_new3, Sb18_new3, Sb19_new3, Sb20_new3, Sb21_new3, Sb22_new3, Sb23_new3, Sb24_new3, Sb25_new3, Sb26_new3)
    JLD2.@save("/data/users/Androniki/Dani/$(label).jld2",data= Data_total)
end
#%%

@showprogress for i in 1:size(z1)[1]
    write_sample(z1[i, :], i)
end
