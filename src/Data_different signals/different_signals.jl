...
function different_signals(z::zPowerLaw,z_N::zNoise, channel::String)
...
function different_signals(z::zPeak,z_N::zNoise,channel::String)
    P,A = z_N.val[1],z_N.val[2]
...
function different_signals(z::zWiggly,z_N::zNoise,channel::String)
...
function different_signals(z::zDouble_peaks,z_N::zNoise,channel::String)
...
function different_signals(z::zBroken_powerlaw,z_N::zNoise,channel::String)
    P,A = z_N.val[1],z_N.val[2]
...
function different_signals(z::zThree_peaks,z_N::zNoise,channel::String)
