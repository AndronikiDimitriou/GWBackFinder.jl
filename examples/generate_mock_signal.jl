...
### Define values for parameters randomly. 10000000 different z (z -> 26 slopes, 1 amplitude, 1 noise parameter A) 
z= npzread("/data/users/Androniki/Dani/z_new.npy")

### Look at an example and plot it 
data,freq=GWBackFinder.model(z[5,:],f,idx,f_filtered,logbins_26,logbins, Sb1, Sb2  , Sb3  , Sb4  , Sb5  , Sb6  , Sb7  , Sb8  , Sb9  , Sb10  , Sb11  , Sb12  , Sb13  , Sb14  , Sb15  , Sb16  , Sb17  , Sb18  , Sb19  , Sb20  , Sb21  , Sb22  , Sb23  , Sb24  , Sb25   )
plt.clf()
